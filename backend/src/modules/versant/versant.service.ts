...
export class VersantService {
    ...
    constructor(
        ...
        this.apiUrl = this.configService.get<string>('VERSANT_API_URL') || 'https://api.mock-versant.com';
        this.apiKey = this.configService.get<string>('VERSANT_API_KEY') || 'mock-key';
    }
    ...
    async processWebhook(payload: any) {
        ...
        await this.prisma.testResult.update({
            ...
            data: {
                score: score,
                status: status === 'completed' ? TestStatus.COMPLETED : TestStatus.FAILED,
