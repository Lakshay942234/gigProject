...
export class WorkController {
    ...
    startSession(@CurrentUser('id') userId: string, @Body() startSessionDto: StartSessionDto) {
    ...
    updateChatSession(@Param('id') id: string, @Body() updateChatDto: UpdateChatSessionDto) {
