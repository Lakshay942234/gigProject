...
import { CreateReviewDto, UpdateReviewDto, ScorecardItemDto } from './dto/qa.dto';
...
export class QaService {
    ...
    async create(reviewerId: string, createReviewDto: CreateReviewDto) {
        ...
        // Calculate scores
        const { totalScore, maxScore } = this.calculateScores(createReviewDto.scorecard);
    ...
    async update(id: string, updateReviewDto: UpdateReviewDto) {
        ...
        if (updateReviewDto.scorecard) {
            const { totalScore, maxScore } = this.calculateScores(updateReviewDto.scorecard);
