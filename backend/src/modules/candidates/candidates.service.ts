...
export class CandidatesService {
    ...
    async create(userId: string, createCandidateDto: CreateCandidateDto): Promise<Candidate> {
        return this.prisma.candidate.create({
            data: {
                ...
                address: createCandidateDto.address ? (createCandidateDto.address as any) : undefined,
    ...
    async update(userId: string, updateCandidateDto: UpdateCandidateDto): Promise<Candidate> {
        ...
        return this.prisma.candidate.update({
            ...
            data: {
                ...updateCandidateDto,
                address: updateCandidateDto.address ? (updateCandidateDto.address as any) : undefined,
            },
        });
    }

    async updateStage(userId: string, stage: OnboardingStage): Promise<Candidate> {
        return this.prisma.candidate.update({
            where: { userId },
