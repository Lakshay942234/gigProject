        ...
        <Router>
            <Routes>
                ...
                <Route element={<RequireAuth />}>
                    ...
                    {/* Admin Routes */}
                    <Route element={<RequireAuth allowedRoles={['ADMIN', 'OPERATIONS']} />}>
                        <Route element={<DashboardLayout />}>
                            ...
                            <Route path="/dashboard/admin/payouts" element={<PayoutsPage />} />
                            <Route path="/dashboard/admin/gigs/create" element={<CreateGigPage />} />
                        </Route>
                    </Route>
