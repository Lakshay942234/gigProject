...
const demoCourses: Course[] = [
  {
    ...
    description:
      "Learn the basics of excellent customer service, including communication skills, empathy, and problem-solving.",
    type: "video",
    duration: "45 min",
    completed: true,
  },
  {
    ...
    description:
      "Understand the standard operating procedures for BPO operations and quality management.",
    type: "document",
    duration: "30 min",
    completed: false,
  },
  {
    ...
    description:
      "Test your communication abilities with this comprehensive quiz.",
    type: "quiz",
    duration: "20 min",
    completed: false,
  },
...
export const LearningPage = () => {
  ...
  const [filter, setFilter] = useState<"all" | "video" | "document" | "quiz">(
    "all"
  );
              ...
              <CardHeader>
                <div className="flex items-start justify-between">
                  <div className="flex items-start gap-3 flex-1">
                    <div
                      className={`p-2 rounded-lg ${getTypeColor(course.type)}`}
                    >
                      {getIcon(course.type)}
                    </div>
              ...
              <CardContent className="mt-auto">
                <div className="flex items-center justify-between">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      navigate(`/dashboard/learning/course/${course.id}`)
                    }
                  >
                    {course.completed ? (
                      <>
      ...
      <Card className="bg-gradient-to-r from-primary/10 to-purple-500/10 border-primary/20">
        <CardContent className="p-6 text-center">
          ...
          <p className="text-muted-foreground text-sm">
            We're constantly adding new courses and materials to help you grow
            your skills.
          </p>
        </CardContent>
      </Card>
