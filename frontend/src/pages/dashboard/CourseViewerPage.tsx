    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          "Always",
          "Never",
          "Only when necessary and explained",
          "When showing expertise",
        ],
        correct: 2,
      },
      {
        ...
        options: [
          ...
          "Wait for them to explain fully",
      ...
      },
      {
        ...
        options: [
          "How loud you speak",
          "The emotion and attitude conveyed",
          "The speed of speech",
  ...
  "6": {
    ...
    quiz: [
      ...
      },
      {
        ...
        options: [
          "Calling the customer back first",
          "Resolving the issue in the first contact",
          "Transferring the call first",
      ...
      },
      {
        ...
        options: [
          "It is not important",
          "To protect customer privacy and company reputation",
          "Only to avoid getting fired",
          "Because IT said so",
        ],
        correct: 1,
      },
  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div className="flex items-center justify-between">
        <Button variant="ghost" onClick={() => navigate("/dashboard/learning")}>
          <ArrowLeft className="mr-2 h-4 w-4" />
          Back to Courses
        </Button>
            ...
            {!showResults ? (
              ...
              <div className="text-center space-y-4">
                ...
                <p className="text-muted-foreground">
                  You got {Math.round((score / 100) * course.quiz.length)} out
                  of {course.quiz.length} questions correct.
                </p>
