        ...
        >
            ...
            <div className="grid gap-4 md:grid-cols-7">
                ...
                <motion.div variants={item} className="col-span-3">
                    {/* Placeholder for Recent Activity or Recommended Gigs */}
                    <div className="glass-card rounded-xl p-6 h-full border border-white/20">
                        ...
                        <div className="space-y-4">
                            {[1, 2, 3].map((i) => (
                                <div key={i} className="flex items-center p-3 rounded-lg hover:bg-white/5 transition-colors cursor-pointer border border-transparent hover:border-white/10">
                                    <div className="h-10 w-10 rounded-full bg-primary/10 flex items-center justify-center mr-4">
                                        <Briefcase className="h-5 w-5 text-primary" />
                                    </div>
                                    <div>
                                        <p className="font-medium text-sm">Customer Support Specialist</p>
                                        <p className="text-xs text-muted-foreground">$15 - $22/hr • Remote</p>
                                    </div>
                                </div>
                            ))}
                        </div>
