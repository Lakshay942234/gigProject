...
export const CreateGigPage = () => {
    ...
    const { register, handleSubmit, formState: { errors } } = useForm<CreateGigForm>();
        ...
        <div className="max-w-3xl mx-auto">
            <div className="flex items-center justify-between mb-8">
                <div>
                    ...
                    <p className="text-muted-foreground mt-2">Post a new work opportunity for candidates.</p>
                </div>
            </div>
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
                    <div className="grid gap-6 md:grid-cols-2">
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                {...register('processType', { required: 'Process Type is required' })}
                        ...
                        <div className="space-y-2">
                            ...
                            <Input
                                type="number"
                                step="0.01"
                                {...register('payRate', { required: 'Pay Rate is required', min: 0 })}
                                placeholder="0.00"
                            />
                        </div>
