...
export const DashboardLayout = () => {
    ...
    const navigation = user?.role === 'ADMIN' || user?.role === 'OPERATIONS'
        ? adminNavigation
        : candidateNavigation;
    ...
    return (
        <div className="min-h-screen bg-gray-50 dark:bg-slate-950 transition-colors duration-300">
            ...
            <div className="flex flex-1 flex-col lg:pl-64 transition-all duration-300">
                {/* Mobile Header */}
                <div className="sticky top-0 z-10 flex h-16 flex-shrink-0 bg-white/80 dark:bg-slate-900/80 backdrop-blur-md shadow-sm lg:hidden border-b border-white/10">
                    <button
                        type="button"
                    ...
                    <div className="flex flex-1 justify-between px-4 items-center">
                        <span className="font-semibold text-lg">BPO Gig</span>
                    </div>
                </div>
