  ...
  return (
    <div className="min-h-screen bg-gray-50 transition-colors duration-300">
      ...
      <AnimatePresence>
        {isSidebarOpen && (
          <motion.div
            ...
            animate={{ opacity: 1 }}
            exit={{ opacity: 0 }}
            className="fixed inset-0 z-40 bg-gray-500/50 backdrop-blur-sm lg:hidden"
      ...
      >
        <div className="flex h-full flex-col">
          ...
          <div className="flex h-16 items-center justify-between px-6 border-b border-gray-200">
            <span className="text-2xl font-bold text-[#14a800]">GigMax</span>
            <button
      ...
      <div className="flex flex-1 flex-col lg:pl-64 transition-all duration-300">
        {/* Mobile Header */}
        <div className="sticky top-0 z-10 flex h-16 flex-shrink-0 bg-white/80 backdrop-blur-md shadow-sm border-b border-gray-200">
          <button
            type="button"
