...
export const ZeptoChatInterface = () => {
    ...
    return (
        <div className="flex h-full flex-col bg-[#f0f2f5] dark:bg-zinc-900 font-sans">
            {/* Header */}
            <header className="flex items-center justify-between bg-[#36046e] px-4 py-3 text-white shadow-md">
                <div className="flex items-center gap-3">
                    <div className="relative">
                        <Avatar className="h-10 w-10 border-2 border-white/20">
                            <AvatarImage src="https://play-lh.googleusercontent.com/cShys-AmJ93dB0SV8kE6Fl5eSaf4-qMMZdwEDKI5VEmKAXfzOqbiaeAsqqrJRemHcFD7" alt="Customer" />
                    ...
                    <div>
                        ...
                        <p className="text-xs text-white/70">Order #ZEP-8821 • 10 items • ₹450</p>
                    </div>
                </div>
            ...
            <ScrollArea className="flex-1 p-4 bg-[url('https://user-images.githubusercontent.com/15075759/28719144-86dc0f70-73b1-11e7-911d-60d70fcded21.png')] bg-repeat">
                <div className="flex flex-col gap-4 max-w-3xl mx-auto">
                    ...
                    {messages.map((msg) => (
                        ...
                        >
                            <div
                                className={`max-w-[80%] rounded-2xl px-4 py-2 shadow-sm ${msg.sender === 'user'
                            ...
                            >
                                ...
                                <p
                                    className={`text-[10px] mt-1 text-right ${msg.sender === 'user' ? 'text-white/60' : 'text-zinc-500'
                                        }`}
                                >
            ...
            {/* Input Area */}
            <div className="bg-white dark:bg-zinc-900 p-3 md:p-4 border-t dark:border-zinc-800">
                <form onSubmit={handleSendMessage} className="max-w-3xl mx-auto flex items-end gap-2">
                    <Button type="button" variant="ghost" size="icon" className="text-zinc-500 hover:text-[#36046e]">
                    ...
                    <div className="flex-1 bg-zinc-100 dark:bg-zinc-800 rounded-2xl px-4 py-2 focus-within:ring-1 focus-within:ring-[#36046e]">
                        <input
                            type="text"
                            value={inputValue}
